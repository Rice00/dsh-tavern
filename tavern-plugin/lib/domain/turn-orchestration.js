...
export function createTurnOrchestrator(options) {
  ...
  async function visibleTools(sessionId) {
    ...
    if (mode === 'script') return ['skill', 'tavern_read_skill_reference', 'tavern_read_script', 'tavern_recall_history', ...webTools]
    ...
    return ['skill', 'tavern_read_skill_reference', 'tavern_recall_history', ...webTools]
  }
