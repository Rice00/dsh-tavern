...
test('更多菜单收起回退和压缩，并可再次关闭', () => {
  ...
  assert.deepEqual(more.children[1].children.map(child => child.type.name || child.children[0]), ['本局后台模型', 'TavernStopBackgroundAction', 'TavernEditBodyAction', 'TavernRollbackAction', 'TavernCompactionAction'])
})
